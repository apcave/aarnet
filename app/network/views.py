...
class SiteViewSet(LoggingViewSetMixin, viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        target_name = request.data.get('name') if isinstance(request.data, dict) else None
...
class ConnectionViewSet(LoggingViewSetMixin, viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        instance = self.get_object()
        log_action('Getting', 'connection', request.user, instance.name or str(instance.connection_id))
        serializer = self.get_serializer(instance)
        return Response(serializer.data)
    ...
    def create(self, request, *args, **kwargs):
        response = super().create(request, *args, **kwargs)
        target_name = request.data.get('name') if isinstance(request.data, dict) else None
        log_action('Creating', 'connection', request.user, target_name or 'new connection')
        return response

    def update(self, request, *args, **kwargs):
        instance = self.get_object()
        response = super().update(request, *args, **kwargs)
        log_action('Updating', 'connection', request.user, instance.name or str(instance.connection_id))
        return response

    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        log_action('Deleting', 'connection', request.user, instance.name or str(instance.connection_id))
        return super().destroy(request, *args, **kwargs)
...
class ConnectionNestedViewSet(LoggingViewSetMixin, viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        instance = self.get_object()
        log_action('Getting', 'connection-full', request.user, instance.name or str(instance.connection_id))
        serializer = self.get_serializer(instance)
        return Response(serializer.data)
    ...
    def create(self, request, *args, **kwargs):
        response = super().create(request, *args, **kwargs)
        target_name = request.data.get('name') if isinstance(request.data, dict) else None
        log_action('Creating', 'connection-full', request.user, target_name or 'new connection')
        return response

    def update(self, request, *args, **kwargs):
        instance = self.get_object()
        response = super().update(request, *args, **kwargs)
        log_action('Updating', 'connection-full', request.user, instance.name or str(instance.connection_id))
        return response

    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        log_action('Deleting', 'connection-full', request.user, instance.name or str(instance.connection_id))
        return super().destroy(request, *args, **kwargs)
...
class NetworkViewSet(LoggingViewSetMixin, viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        response = super().create(request, *args, **kwargs)
        target_name = request.data.get('title') if isinstance(request.data, dict) else None
